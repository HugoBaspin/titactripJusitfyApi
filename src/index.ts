...
dotenv.config();
// Dependencies must be loaded after dotenv.config()
const logger = require('./config/dependencies').getLogger();
...
const routing = [
  // GET    /test
  { prefix: '/test', router: require('./src/test/get').router },
  // // GET    /test/database
  // { prefix: '/test', router: require('./src/test/database').router },
